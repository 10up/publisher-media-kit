...
function block_patterns_and_categories()
{
	...
	register_block_pattern(
		...
		array(
			...
			'categories'  => [ 'publisher-media-kit' ],
			'content'     => '<!-- wp:group {"align":"wide","className":"pmk-why-digital"} --><div class="wp-block-group alignwide pmk-why-digital"><!-- wp:heading {"level":2} --><h2 class="has-text-align-center">Why you should choose digital</h2><!-- /wp:heading --><!-- wp:columns {"align":"wide"} --><div class="wp-block-columns alignwide"><!-- wp:column {"className":"pmk-digital-column pmk-digital-column-source"} --><div class="wp-block-column pmk-digital-column pmk-digital-column-source"><!-- wp:image {"width":35,"height":35} --><figure class="wp-block-image is-resized"><img src="/wp-content/plugins/publisher-media-kit/assets/images/icon-digital-1.png" alt="Female visitors" width="35" height="35"/></figure><!-- /wp:image --><!-- wp:heading {"level":3} --><h3>Source</h3><!-- /wp:heading --><!-- wp:paragraph --><p>WSVN is the leading news source in Miami. Making it South Florida’s GO-TO choice to stay informed on anything news, weather, sports &amp; entertainment.</p><!-- /wp:paragraph --></div><!-- /wp:column --><!-- wp:column {"className":"pmk-digital-column pmk-digital-column-visibility"} --><div class="wp-block-column pmk-digital-column pmk-digital-column-visibility"><!-- wp:image {"width":35,"height":35} --><figure class="wp-block-image is-resized"><img src="/wp-content/plugins/publisher-media-kit/assets/images/icon-digital-2.png" alt="Female visitors" width="35" height="35"/></figure><!-- /wp:image --><!-- wp:heading {"level":3} --><h3>Visibility</h3><!-- /wp:heading --><!-- wp:paragraph --><p>All ad units across the site have a viewability percentage of 70% of higher, making “above-the-fold” a thing of the past!</p><!-- /wp:paragraph --></div><!-- /wp:column --><!-- wp:column {"className":"pmk-digital-column pmk-digital-column-measure"} --><div class="wp-block-column pmk-digital-column pmk-digital-column-measure"><!-- wp:image {"width":35,"height":35} --><figure class="wp-block-image is-resized"><img src="/wp-content/plugins/publisher-media-kit/assets/images/icon-digital-3.png" alt="Female visitors" width="35" height="35"/></figure><!-- /wp:image --><!-- wp:heading {"level":3} --><h3>Measure</h3><!-- /wp:heading --><!-- wp:paragraph --><p>WSVN has Measurable ROI! Ads on WSVN.com have high click-through percentages against industry benchmark rates.</p><!-- /wp:paragraph --></div><!-- /wp:column --></div><!-- /wp:columns --><!-- wp:buttons {"contentJustification":"center"} --><div class="wp-block-buttons is-content-justification-center"><!-- wp:button {"className":"is-style-fill pmk-button"} --><div class="wp-block-button is-style-fill pmk-button"><a class="wp-block-button__link">CONTACT US</a></div><!-- /wp:button --></div><!-- /wp:buttons --></div><!-- /wp:group -->',
		)
	);
